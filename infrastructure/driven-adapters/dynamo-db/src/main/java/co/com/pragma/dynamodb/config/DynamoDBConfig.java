...
public class DynamoDBConfig {
    ...
    @Bean
    public DynamoDbAsyncTable<ReporteEntity> reporteEntityTable(DynamoDbEnhancedAsyncClient enhancedAsyncClient) {
        return enhancedAsyncClient.table("reporte", TableSchema.fromBean(ReporteEntity.class));
    }
